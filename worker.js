...
async function handleRequest(request) {
  ...
  const TO_EMAIL = 'contraentregacofz2@proton.me';
  const SENDER_EMAIL = ''; // Reemplaza con tu correo verificado
  const SENDER_NAME = 'FZ2';
  const SENDGRID_API_KEY = ''; // Configura en variables de entorno
